            ...
            <PieChart>
              ...
              >
                {statusData.map((entry, index) => {
                  let fillColor = "#ccc";
                  if (entry.name === "Pending") fillColor = "#a78bfa"; // Purple
                  else if (entry.name === "In Progress")
                    fillColor = "#38bdf8"; // Blue
                  else if (entry.name === "Completed") fillColor = "#34d399"; // Green
            ...
            <BarChart data={priorityData}>
              ...
              <Bar dataKey="value">
                {priorityData.map((entry, index) => {
                  let fillColor = "#ccc";
                  if (entry.name === "Low") fillColor = "#34d399"; // Green
                  else if (entry.name === "Medium")
                    fillColor = "#fbbf24"; // Yellow
                  else if (entry.name === "High") fillColor = "#f87171"; // Red
